...
const mockReservations: Reservation[] = [
  {
    ...
    montant: 10000,
    statut: 'CONFIRMED',
    notes: 'Visite guidée avec guide francophone',
  ...
  },
  {
    ...
    montant: 45000,
    statut: 'PENDING',
    notes: 'Arrivée prévue à 14h, petit-déjeuner inclus',
  ...
  },
  {
    ...
    montant: 100000,
    statut: 'COMPLETED',
    notes: 'Safari de 3 jours avec guide expérimenté',
  ...
  },
  {
    ...
    offre: {
      id: 'offre-4',
      titre: 'Restaurant La Teranga - Dîner',
      images: ['/images/ba3.png'],
      type: 'RESTAURANT',
      region: 'Dakar',
      ville: 'Dakar',
    ...
    montant: 16000,
    statut: 'CONFIRMED',
    notes: 'Réservation pour 20h, table près de la fenêtre',
  ...
  },
  {
    ...
    montant: 75000,
    statut: 'PENDING',
    notes: 'Visite de la ville historique et du parc national',
